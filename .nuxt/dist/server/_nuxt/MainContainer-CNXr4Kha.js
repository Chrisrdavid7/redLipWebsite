...
import { ssrRenderAttrs, ssrRenderStyle, ssrRenderComponent, ssrRenderClass, ssrRenderSlot } from "vue/server-renderer";
import { _ as _export_sfc, M as MainFooter, a as MainHeader } from "../server.mjs";
const _sfc_main$1 = {
  components: {
...
const _sfc_main = {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "main-wrap" }, _attrs))} data-v-89815d05>`);
      _push(ssrRenderComponent(unref(MainHeader), { invert: __props.invert }, null, _parent));
      _push(`<div class="${ssrRenderClass([{ "scroll-nav-content": __props.navScroll }, "container-wrap"])}" data-v-89815d05>`);
...
const MainContainer = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-89815d05"]]);
export {
  MainContainer as M
};
//# sourceMappingURL=MainContainer-CNXr4Kha.js.map
