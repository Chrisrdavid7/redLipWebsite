...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "root" }, _attrs))} data-v-b15ae9b7><div class="theShows" data-v-b15ae9b7>`);
              ...
              _push3(ssrRenderComponent(_component_v_col, {
                ...
                default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                  if (_push4) {
                    ...
                    _push4(`<span class="${ssrRenderClass($options.isTablet ? "text-center custom-text" : "custom-text")}" data-v-b15ae9b7${_scopeId3}> The award-winning team behind... </span>`);
                  } else {
                    return [
          ...
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(ssrRenderComponent(_component_v_col, {
                ...
                default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                  if (_push4) {
                    _push4(`<h2 class="section-title1" data-v-b15ae9b7${_scopeId3}>Original Casting and Development</h2>`);
                  } else {
                    return [
          ...
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(ssrRenderComponent(_component_v_col, {
                ...
                default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                  if (_push4) {
                    _push4(`<h2 class="section-title2" data-v-b15ae9b7${_scopeId3}>Series Castings</h2>`);
                  } else {
                    return [
...
const Shows = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-b15ae9b7"]]);
export {
  Shows as S
};
//# sourceMappingURL=ShowsPage-B8dc7bfI.js.map
