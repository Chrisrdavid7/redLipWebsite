import { T as Title, M as MovieThumb, i as imgAPI } from "./MovieThumb-DDVI_J62.js";
import { useSSRContext, resolveComponent, mergeProps, withCtx, createVNode, createTextVNode, openBlock, createBlock, Fragment, renderList } from "vue";
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "root" }, _attrs))} data-v-478eb8b3><div class="theShows" data-v-478eb8b3>`);
            ...
            if (_push3) {
              _push3(ssrRenderComponent(_component_v_col, {
                ...
                default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                  if (_push4) {
                    _push4(`<h1 class="custom-title" data-v-478eb8b3${_scopeId3}><span class="primary-text" data-v-478eb8b3${_scopeId3}>The</span> <span class="secondary-text" data-v-478eb8b3${_scopeId3}>Shows</span></h1><p class="custom-subtitle" data-v-478eb8b3${_scopeId3}>The award-winning team behind...</p>`);
                  } else {
                    return [
                      createVNode("h1", { class: "custom-title" }, [
                        createVNode("span", { class: "primary-text" }, "The"),
                        createTextVNode(),
                        createVNode("span", { class: "secondary-text" }, "Shows")
                      ]),
                      createVNode("p", { class: "custom-subtitle" }, "The award-winning team behind...")
                    ];
                  }
                }),
                _: 1
          ...
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(ssrRenderComponent(_component_v_col, {
                ...
                default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                  if (_push4) {
                    _push4(`<h2 class="section-title1" data-v-478eb8b3${_scopeId3}>Original Casting and Development</h2>`);
                  } else {
                    return [
          ...
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(ssrRenderComponent(_component_v_col, {
                ...
                default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                  if (_push4) {
                    _push4(`<h2 class="section-title2" data-v-478eb8b3${_scopeId3}>Series Castings</h2>`);
                  } else {
                    return [
...
const Shows = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-478eb8b3"]]);
export {
  Shows as S
};
//# sourceMappingURL=ShowsPage-BVVbSmdz.js.map
