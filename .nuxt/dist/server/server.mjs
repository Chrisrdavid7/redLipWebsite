var _a;
import { effectScope, shallowReactive, reactive, getCurrentScope, hasInjectionContext, getCurrentInstance as getCurrentInstance$1, inject as inject$1, toRef, version as version$1, unref, ref, watchEffect, watch, h, shallowRef, isReadonly, isRef, isShallow, isReactive, toRaw, defineComponent as defineComponent$1, computed, Fragment, createVNode, Text, onServerPrefetch, toRefs, provide, createElementBlock, resolveComponent, mergeProps, useSSRContext, capitalize, warn as warn$2, camelize, onScopeDispose, readonly, TransitionGroup, Transition, nextTick, withDirectives, resolveDirective, vShow, resolveDynamicComponent, Teleport, cloneVNode, createTextVNode, vModelText, Suspense, withCtx, renderSlot, toDisplayString, openBlock, createBlock, createCommentVNode, renderList, withModifiers, onErrorCaptured, createApp } from "vue";
import { $fetch } from "ofetch";
import { baseURL } from "#internal/nuxt/paths";
import { createHooks } from "hookable";
import { getContext } from "unctx";
import { sanitizeStatusCode, createError as createError$1, appendHeader, getRequestHeaders } from "h3";
import { getActiveHead, CapoPlugin } from "unhead";
import { defineHeadPlugin, composableNames } from "@unhead/shared";
import { START_LOCATION, createMemoryHistory, createRouter as createRouter$1, useRouter as useRouter$2, useRoute as useRoute$1, RouterView } from "vue-router";
import { toRouteMatcher, createRouter } from "radix3";
import { defu } from "defu";
import { hasProtocol, isScriptProtocol, joinURL, withQuery, isEqual as isEqual$1, parseQuery, withTrailingSlash as withTrailingSlash$1, withoutTrailingSlash as withoutTrailingSlash$1 } from "ufo";
import "devalue";
...
import { ssrRenderAttrs, ssrRenderSlot, ssrRenderComponent, ssrRenderClass, ssrInterpolate, ssrRenderList, ssrGetDirectiveProps, ssrRenderAttr, ssrRenderSuspense, ssrRenderVNode } from "vue/server-renderer";
...
const _routes = [
  ...
  },
  {
    name: "blank-page",
    path: "/blank-page",
    component: () => import("./_nuxt/blank-page-DuG0NlMm.js").then((m) => m.default || m)
  },
  {
    name: "contact",
    path: "/contact",
    component: () => import("./_nuxt/contact-BYDw0Woh.js").then((m) => m.default || m)
  },
  {
    name: "detail-movie",
    path: "/detail-movie",
    component: () => import("./_nuxt/detail-movie-ldp_DdLR.js").then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    component: () => import("./_nuxt/index-BiirQmkc.js").then((m) => m.default || m)
  },
  {
    name: "login",
    path: "/login",
    component: () => import("./_nuxt/login-DmT7vL_G.js").then((m) => m.default || m)
  },
  {
    name: "news",
    path: "/news",
    component: () => import("./_nuxt/news-BwvtAErC.js").then((m) => m.default || m)
  },
  {
    name: "register",
    path: "/register",
    component: () => import("./_nuxt/register-Dq_WMJrT.js").then((m) => m.default || m)
  },
  {
    name: "shows",
    path: "/shows",
    component: () => import("./_nuxt/shows-0kBYGbPz.js").then((m) => m.default || m)
  }
];
...
function useAsyncData(...args) {
  ...
  const nuxtApp = useNuxtApp();
  const handler = !import.meta.prerender || !((_a2 = nuxtApp.ssrContext) == null ? void 0 : _a2._sharedPrerenderCache) ? _handler : () => {
...
const layouts = {
  default: () => import("./_nuxt/default-Buy5__a1.js").then((m) => m.default || m)
};
