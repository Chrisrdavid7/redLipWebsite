import { useSSRContext, mergeProps, resolveComponent, withCtx, createVNode, toDisplayString } from 'file:///Users/chrisdavid/Desktop/chelseyCreativeWebsite/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrInterpolate, ssrRenderComponent, ssrRenderAttr } from 'file:///Users/chrisdavid/Desktop/chelseyCreativeWebsite/node_modules/vue/server-renderer/index.mjs';
...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  }, _attrs))} data-v-94cb9a56><h4 class="primary-title" data-v-94cb9a56>${ssrInterpolate($props.primary)}</h4><h4 class="secondary-title" data-v-94cb9a56>${ssrInterpolate($props.secondary)}</h4><h4 class="primary-title2" data-v-94cb9a56>${ssrInterpolate($props.primary2)}</h4><h4 class="secondary-title2" data-v-94cb9a56>${ssrInterpolate($props.secondary2)}</h4></div>`);
}
...
const Title = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["ssrRender", _sfc_ssrRender$1], ["__scopeId", "data-v-94cb9a56"]]);
const _sfc_main = {
  props: {
    img: {
      type: String,
...
export { MovieThumb as M, Title as T, imgAPI as i };
//# sourceMappingURL=MovieThumb-D9hnvVSp.mjs.map
