...
import { i as imgAPI, T as Title, M as MovieThumb } from './MovieThumb-D9hnvVSp.mjs';
import { _ as _export_sfc$1, d as defineNuxtComponent, H as Hidden, u as useLocalePath, l as link, m as menu2 } from './server.mjs';
import { defineComponent, onUpdated, inject, ref, onMounted, onBeforeUnmount, watch, provide, computed, openBlock, createElementBlock, createElementVNode, renderSlot, resolveComponent, createBlock, resolveDynamicComponent, withCtx, useSSRContext, createVNode, mergeProps, createCommentVNode, createTextVNode, toDisplayString, Fragment, renderList, resolveDirective, withDirectives } from 'file:///Users/chrisdavid/Desktop/chelseyCreativeWebsite/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderAttr, ssrRenderClass, ssrRenderList, ssrInterpolate, ssrGetDirectiveProps } from 'file:///Users/chrisdavid/Desktop/chelseyCreativeWebsite/node_modules/vue/server-renderer/index.mjs';
import { s as setInterval } from './interval-gl53xdpR.mjs';
import { p as publicAssetsURL } from '../_/renderer.mjs';
import { A as About } from './About-DYah-hvS.mjs';
import AOS from 'file:///Users/chrisdavid/Desktop/chelseyCreativeWebsite/node_modules/aos/dist/aos.js';
...
const SplideSlide = /* @__PURE__ */ _export_sfc(_sfc_main$g, [["render", _sfc_render]]);
...
const VideoBanner = /* @__PURE__ */ _export_sfc$1(_sfc_main$f, [["ssrRender", _sfc_ssrRender$f], ["__scopeId", "data-v-30f21689"]]);
const sliderData = [
  {
...
function _sfc_ssrRender$e(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  const _component_v_btn = resolveComponent("v-btn");
  const _component_hidden = resolveComponent("hidden");
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "root" }, _attrs))} data-v-6234f0cd><div class="slider-wrap" data-v-6234f0cd><div${ssrRenderAttrs({ name: $data.transition })} data-v-6234f0cd>`);
  ssrRenderList([$data.currentImg], (number) => {
    _push(`<div class="slide slider-content" data-v-6234f0cd><div class="inner item" data-v-6234f0cd><div class="inner-bg" data-v-6234f0cd><div class="background" data-v-6234f0cd><figure data-v-6234f0cd><img${ssrRenderAttr("src", $data.content[Math.abs($data.currentImg) % $data.content.length].image)} alt="promotion" data-v-6234f0cd></figure></div>`);
      ...
      default: withCtx((_, _push2, _parent2, _scopeId) => {
        if (_push2) {
          _push2(ssrRenderComponent(_component_v_col, {
            ...
            default: withCtx((_2, _push3, _parent3, _scopeId2) => {
              if (_push3) {
                _push3(`<div class="text" data-v-6234f0cd${_scopeId2}><h4 data-v-6234f0cd${_scopeId2}><span class="use-text-subtitle2" data-v-6234f0cd${_scopeId2}>${ssrInterpolate($data.content[Math.abs($data.currentImg) % $data.content.length].subtitle)}</span> ${ssrInterpolate($data.content[Math.abs($data.currentImg) % $data.content.length].title)}</h4><div class="property" data-v-6234f0cd${_scopeId2}> Confidential </div><article class="desc" data-v-6234f0cd${_scopeId2}><h6 class="use-text-paragraph" data-v-6234f0cd${_scopeId2}>${ssrInterpolate($data.content[Math.abs($data.currentImg) % $data.content.length].desc)}</h6></article><div class="btn-area" data-v-6234f0cd${_scopeId2}>`);
                _push3(ssrRenderComponent(_component_v_btn, {
                  class: "custom-button",
            ...
            default: withCtx((_2, _push3, _parent3, _scopeId2) => {
              if (_push3) {
                _push3(ssrRenderComponent(_component_hidden, { point: "xsDown" }, {
                  default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                    if (_push4) {
                      _push4(`<div class="image" data-v-6234f0cd${_scopeId3}><figure data-v-6234f0cd${_scopeId3}><img${ssrRenderAttr("src", $data.content[Math.abs($data.currentImg) % $data.content.length].image)} alt="promotion" data-v-6234f0cd${_scopeId3}></figure></div>`);
                    } else {
                      return [
  ...
  _push(`</div></div><a href="javascript:void(0)" class="prev" data-v-6234f0cd><i class="ion-ios-arrow-round-back-outline arrow-icon" data-v-6234f0cd></i></a><a href="javascript:void(0)" class="next" data-v-6234f0cd><i class="ion-ios-arrow-round-forward-outline arrow-icon" data-v-6234f0cd></i></a></div>`);
}
...
const Promotions = /* @__PURE__ */ _export_sfc$1(_sfc_main$e, [["ssrRender", _sfc_ssrRender$e], ["__scopeId", "data-v-6234f0cd"]]);
...
function _sfc_ssrRender$d(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "root" }, _attrs))} data-v-0ca30ebd><div class="decoration" data-v-0ca30ebd><svg fill="#cccccc" data-v-0ca30ebd><use${ssrRenderAttr("xlink:href", _imports_0$1 + "#main")} data-v-0ca30ebd></use></svg></div>`);
              ...
              _push3(ssrRenderComponent(_component_v_col, {
                ...
                default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                  if (_push4) {
                    ...
                    _push4(`<span class="${ssrRenderClass($options.isTablet ? "text-center custom-text" : "custom-text")}" data-v-0ca30ebd${_scopeId3}> The casting team behind... </span>`);
                  } else {
                    return [
...
const Featured = /* @__PURE__ */ _export_sfc$1(_sfc_main$d, [["ssrRender", _sfc_ssrRender$d], ["__scopeId", "data-v-0ca30ebd"]]);
const _sfc_main$c = {
  components: {
    Hidden,
    Splide,
...
const Trending = /* @__PURE__ */ _export_sfc$1(_sfc_main$c, [["ssrRender", _sfc_ssrRender$c], ["__scopeId", "data-v-4bd48824"]]);
const _sfc_main$b = {
  components: {
    Hidden
  },
...
const CategoryBigCard = /* @__PURE__ */ _export_sfc$1(_sfc_main$b, [["ssrRender", _sfc_ssrRender$b], ["__scopeId", "data-v-703b58d8"]]);
const _sfc_main$a = {
  props: {
    img: {
      type: String,
...
const CategorySmallCard = /* @__PURE__ */ _export_sfc$1(_sfc_main$a, [["ssrRender", _sfc_ssrRender$a], ["__scopeId", "data-v-d4ca6784"]]);
const _sfc_main$9 = {
  components: {
    CategoryBigCard,
    CategorySmallCard,
...
const Categories = /* @__PURE__ */ _export_sfc$1(_sfc_main$9, [["ssrRender", _sfc_ssrRender$9], ["__scopeId", "data-v-97b33d95"]]);
const _sfc_main$8 = {
  setup() {
...
const SimpleThumbCard = /* @__PURE__ */ _export_sfc$1(_sfc_main$8, [["ssrRender", _sfc_ssrRender$8], ["__scopeId", "data-v-bdb29f82"]]);
...
const AllCategories = /* @__PURE__ */ _export_sfc$1(_sfc_main$7, [["ssrRender", _sfc_ssrRender$7], ["__scopeId", "data-v-e2b0e967"]]);
const _sfc_main$6 = {
  props: {
    title: {
      type: String,
...
const PricingCard = /* @__PURE__ */ _export_sfc$1(_sfc_main$6, [["ssrRender", _sfc_ssrRender$6], ["__scopeId", "data-v-8975ac68"]]);
const featureList = {
  basic: [
...
const PricingPlan = /* @__PURE__ */ _export_sfc$1(_sfc_main$5, [["ssrRender", _sfc_ssrRender$5], ["__scopeId", "data-v-bca584d5"]]);
...
const Faq = /* @__PURE__ */ _export_sfc$1(_sfc_main$4, [["ssrRender", _sfc_ssrRender$4], ["__scopeId", "data-v-20247dcc"]]);
const _sfc_main$3 = {
  props: {
    text: {
      type: String,
...
const NewsCard = /* @__PURE__ */ _export_sfc$1(_sfc_main$3, [["ssrRender", _sfc_ssrRender$3], ["__scopeId", "data-v-131bf984"]]);
const newsContent = [
  {
...
const NewsEvent = /* @__PURE__ */ _export_sfc$1(_sfc_main$2, [["ssrRender", _sfc_ssrRender$2], ["__scopeId", "data-v-001f5204"]]);
let counter = 0;
...
const PageNav = /* @__PURE__ */ _export_sfc$1(_sfc_main$1, [["ssrRender", _sfc_ssrRender$1], ["__scopeId", "data-v-6262a61b"]]);
...
const index = /* @__PURE__ */ _export_sfc$1(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-6dd6d8d8"]]);

export { index as default };
//# sourceMappingURL=index-BiirQmkc.mjs.map
