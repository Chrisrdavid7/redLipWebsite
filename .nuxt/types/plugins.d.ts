...
type NuxtAppInjections = 
  ...
  InjectionType<typeof import("../../node_modules/@nuxtjs/i18n/dist/runtime/plugins/composition.mjs").default> &
  InjectionType<typeof import("../../node_modules/@nuxtjs/i18n/dist/runtime/plugins/i18n.mjs").default> &
  InjectionType<typeof import("../../plugins/light-box.js").default> &
  InjectionType<typeof import("../../plugins/media-query.js").default> &
  InjectionType<typeof import("../../plugins/parallax-hover.js").default> &
  InjectionType<typeof import("../../plugins/parallax.js").default> &
  InjectionType<typeof import("../../plugins/smooth-scroll.js").default> &
  InjectionType<typeof import("../../plugins/vuetify.js").default> &
  InjectionType<typeof import("../../plugins/youtube.js").default>

declare module '#app' {
  interface NuxtApp extends NuxtAppInjections { }

  interface NuxtAppLiterals {
    pluginName: 'nuxt:revive-payload:client' | 'nuxt:head' | 'nuxt:router' | 'nuxt:payload' | 'nuxt:revive-payload:server' | 'nuxt:chunk-reload' | 'nuxt:global-components' | 'nuxt:prefetch' | 'i18n:plugin'
  }
}
