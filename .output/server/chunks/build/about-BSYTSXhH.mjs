...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "team-container" }, _attrs))} data-v-20062904><div class="about-us-container" data-v-20062904><h2 data-v-20062904>About Us</h2><p data-v-20062904> Led by founder and CEO Chelsey Stephens, Red Lip Productions is a dynamic, full-service content development, casting and televison production company based in New York City, where creativity drives everything we do. With over 15 years of award-winning experience, our core team specializes in content development, creating hit series, and turning real people into superstars. We collaborate with top networks and streaming platforms to develop new shows and cast for existing series, ensuring every project reaches its full creative potential. </p></div></div>`);
}
...
const About = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["ssrRender", _sfc_ssrRender$1], ["__scopeId", "data-v-20062904"]]);
const _sfc_main = {
  components: {
    MainContainer,
    About
...
//# sourceMappingURL=about-BSYTSXhH.mjs.map
