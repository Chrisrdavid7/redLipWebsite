...
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderAttr, ssrRenderList, ssrRenderStyle, ssrInterpolate, ssrRenderClass, ssrGetDirectiveProps } from 'vue/server-renderer';
import { _ as _export_sfc$1, d as defineNuxtComponent, H as Hidden, m as menu2 } from './server.mjs';
import { s as setInterval } from './interval-gl53xdpR.mjs';
import { i as imgAPI, T as Title, M as MovieThumb } from './MovieThumb-DDVI_J62.mjs';
...
function _sfc_ssrRender$6(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "video-container" }, _attrs))} data-v-d2f5ab28><div class="video" data-v-d2f5ab28><iframe width="100%" height="100%"${ssrRenderAttr("src", "https://www.youtube.com/embed/" + $data.videoId + "?autoplay=1&mute=1&controls=0&rel=0&showinfo=0")} frameborder="0" allow="autoplay; encrypted-media" allowfullscreen data-v-d2f5ab28></iframe><div class="video-caption" data-v-d2f5ab28><h1 data-v-d2f5ab28>The Real Housewives of Potomac</h1><p data-v-d2f5ab28>October 6th on Bravo Networks</p></div></div></div>`);
}
...
const VideoBanner = /* @__PURE__ */ _export_sfc$1(_sfc_main$6, [["ssrRender", _sfc_ssrRender$6], ["__scopeId", "data-v-d2f5ab28"]]);
const sliderData = [
  {
...
const _sfc_main$5 = {
  ...
  computed: {
    currentSlide() {
      const index2 = Math.abs(this.currentImg) % this.content.length;
...
function _sfc_ssrRender$5(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "root" }, _attrs))} data-v-e43dc5c0><div class="slider-wrap" data-v-e43dc5c0><div${ssrRenderAttrs({ name: $data.transition })} data-v-e43dc5c0>`);
  ssrRenderList([$data.currentImg], (number) => {
    _push(`<div class="slide slider-content" data-v-e43dc5c0><div class="inner item" data-v-e43dc5c0><div class="inner-bg" data-v-e43dc5c0><div class="background" data-v-e43dc5c0><figure data-v-e43dc5c0><img${ssrRenderAttr("src", $options.currentSlide.image)} alt="promotion" data-v-e43dc5c0></figure></div>`);
        ...
        if (_push2) {
          _push2(ssrRenderComponent(_component_v_col, {
            ...
            default: withCtx((_2, _push3, _parent3, _scopeId2) => {
              if (_push3) {
                _push3(`<div class="text" data-v-e43dc5c0${_scopeId2}><h4 style="${ssrRenderStyle({ color: $options.currentSlide.color })}" data-v-e43dc5c0${_scopeId2}><span class="use-text-subtitle2" data-v-e43dc5c0${_scopeId2}>${ssrInterpolate($options.currentSlide.subtitle)}</span> ${ssrInterpolate($options.currentSlide.title)}</h4><div class="property" style="${ssrRenderStyle({ color: $options.currentSlide.color })}" data-v-e43dc5c0${_scopeId2}> Confidential </div><article class="desc" style="${ssrRenderStyle({ color: $options.currentSlide.color })}" data-v-e43dc5c0${_scopeId2}><h6 class="use-text-paragraph" data-v-e43dc5c0${_scopeId2}>${ssrInterpolate($options.currentSlide.desc)}</h6></article><div class="btn-area" data-v-e43dc5c0${_scopeId2}>`);
                _push3(ssrRenderComponent(_component_v_btn, {
                  class: "custom-button",
                  href: $options.currentSlide.link
                }, {
                ...
                return [
                  createVNode("div", { class: "text" }, [
                    createVNode("h4", {
                      style: { color: $options.currentSlide.color }
                    }, [
                      createVNode("span", { class: "use-text-subtitle2" }, toDisplayString($options.currentSlide.subtitle), 1),
                      createTextVNode(" " + toDisplayString($options.currentSlide.title), 1)
                    ], 4),
                    createVNode("div", {
                      class: "property",
                      style: { color: $options.currentSlide.color }
                    ...
                    createVNode("article", {
                      ...
                      createVNode("h6", { class: "use-text-paragraph" }, toDisplayString($options.currentSlide.desc), 1)
                    ], 4),
            ...
            default: withCtx((_2, _push3, _parent3, _scopeId2) => {
              if (_push3) {
                _push3(ssrRenderComponent(_component_hidden, { point: "xsDown" }, {
                  default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                    if (_push4) {
                      _push4(`<div class="image" data-v-e43dc5c0${_scopeId3}><figure data-v-e43dc5c0${_scopeId3}><img${ssrRenderAttr("src", $options.currentSlide.image)} alt="promotion" data-v-e43dc5c0${_scopeId3}></figure></div>`);
                    } else {
                      return [
                        createVNode("div", { class: "image" }, [
                          createVNode("figure", null, [
                            createVNode("img", {
                              src: $options.currentSlide.image,
                              alt: "promotion"
                            }, null, 8, ["src"])
                          ])
                        ])
  ...
  _push(`</div></div><a href="javascript:void(0)" class="prev" data-v-e43dc5c0><i class="ion-ios-arrow-round-back-outline arrow-icon" data-v-e43dc5c0></i></a><a href="javascript:void(0)" class="next" data-v-e43dc5c0><i class="ion-ios-arrow-round-forward-outline arrow-icon" data-v-e43dc5c0></i></a></div>`);
}
...
const Promotions = /* @__PURE__ */ _export_sfc$1(_sfc_main$5, [["ssrRender", _sfc_ssrRender$5], ["__scopeId", "data-v-e43dc5c0"]]);
...
const Featured = /* @__PURE__ */ _export_sfc$1(_sfc_main$4, [["ssrRender", _sfc_ssrRender$4], ["__scopeId", "data-v-736e4790"]]);
const _sfc_main$3 = {
  props: {
    text: {
      type: String,
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<div${ssrRenderAttrs(_attrs)} data-v-a2ed7ee4>`);
  _push(ssrRenderComponent(_component_main_container, { "nav-scroll": "" }, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<section id="home" data-v-a2ed7ee4${_scopeId}>`);
        _push2(ssrRenderComponent(_component_video_banner, null, null, _parent2, _scopeId));
        _push2(`</section><div id="promotions" data-v-a2ed7ee4${_scopeId}>`);
        _push2(ssrRenderComponent(_component_promotions, null, null, _parent2, _scopeId));
        _push2(`</div><section id="featured" class="space-top" data-v-a2ed7ee4${_scopeId}>`);
        _push2(ssrRenderComponent(_component_featured, null, null, _parent2, _scopeId));
        _push2(`</section><section id="news" class="space-top-short" data-v-a2ed7ee4${_scopeId}>`);
...
const index = /* @__PURE__ */ _export_sfc$1(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-a2ed7ee4"]]);

export { index as default };
//# sourceMappingURL=index-B2qGbH06.mjs.map
