...
import { i as imgAPI, T as Title, M as MovieThumb } from './MovieThumb-CVKkt35y.mjs';
...
function _sfc_ssrRender$6(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "video-container" }, _attrs))} data-v-21c7346b><div class="video" data-v-21c7346b><iframe width="100%" height="100%"${ssrRenderAttr("src", "https://www.youtube.com/embed/" + $data.videoId + "?autoplay=1&mute=1&controls=0&rel=0&showinfo=0")} frameborder="0" allow="autoplay; encrypted-media" allowfullscreen data-v-21c7346b></iframe><div class="video-caption" data-v-21c7346b><h1 data-v-21c7346b>I Love Andriana</h1><p data-v-21c7346b>Bravo Networks</p></div></div></div>`);
}
...
const VideoBanner = /* @__PURE__ */ _export_sfc$1(_sfc_main$6, [["ssrRender", _sfc_ssrRender$6], ["__scopeId", "data-v-21c7346b"]]);
const sliderData = [
  {
...
function _sfc_ssrRender$5(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "root" }, _attrs))} data-v-74687af7><div class="slider-wrap" data-v-74687af7><div${ssrRenderAttrs({ name: $data.transition })} data-v-74687af7>`);
  ssrRenderList([$data.currentImg], (number) => {
    _push(`<div class="slide slider-content" data-v-74687af7><div class="inner item" data-v-74687af7><div class="inner-bg" data-v-74687af7><div class="background" data-v-74687af7><figure data-v-74687af7><img${ssrRenderAttr("src", $options.currentSlide.image)} alt="promotion" data-v-74687af7></figure></div>`);
        ...
        if (_push2) {
          _push2(ssrRenderComponent(_component_v_col, {
            ...
            default: withCtx((_2, _push3, _parent3, _scopeId2) => {
              if (_push3) {
                _push3(`<div class="text" data-v-74687af7${_scopeId2}><h4 style="${ssrRenderStyle({ color: $options.currentSlide.color })}" data-v-74687af7${_scopeId2}><span class="use-text-subtitle2" data-v-74687af7${_scopeId2}>${ssrInterpolate($options.currentSlide.subtitle)}</span> ${ssrInterpolate($options.currentSlide.title)}</h4><div class="property" style="${ssrRenderStyle({ color: $options.currentSlide.color })}" data-v-74687af7${_scopeId2}> Confidential </div><article class="desc" style="${ssrRenderStyle({ color: $options.currentSlide.color })}" data-v-74687af7${_scopeId2}><h6 class="use-text-paragraph" data-v-74687af7${_scopeId2}>${ssrInterpolate($options.currentSlide.desc)}</h6></article><div class="btn-area" data-v-74687af7${_scopeId2}>`);
            ...
            default: withCtx((_2, _push3, _parent3, _scopeId2) => {
              if (_push3) {
                _push3(ssrRenderComponent(_component_hidden, { point: "xsDown" }, {
                  default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                    if (_push4) {
                      _push4(`<div class="image" data-v-74687af7${_scopeId3}><figure data-v-74687af7${_scopeId3}><img${ssrRenderAttr("src", $options.currentSlide.image)} alt="promotion" data-v-74687af7${_scopeId3}></figure></div>`);
                    } else {
                      return [
  ...
  _push(`</div></div><a href="javascript:void(0)" class="prev" data-v-74687af7><i class="ion-ios-arrow-round-back-outline arrow-icon" data-v-74687af7></i></a><a href="javascript:void(0)" class="next" data-v-74687af7><i class="ion-ios-arrow-round-forward-outline arrow-icon" data-v-74687af7></i></a></div>`);
}
...
const Promotions = /* @__PURE__ */ _export_sfc$1(_sfc_main$5, [["ssrRender", _sfc_ssrRender$5], ["__scopeId", "data-v-74687af7"]]);
...
//# sourceMappingURL=index-CL3jbwCi.mjs.map
