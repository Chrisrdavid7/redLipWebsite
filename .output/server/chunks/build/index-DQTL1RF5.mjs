...
function _sfc_ssrRender$6(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "video-container" }, _attrs))} data-v-8b39cdcd><div class="video" data-v-8b39cdcd><iframe width="100%" height="100%"${ssrRenderAttr("src", "https://www.youtube.com/embed/" + $data.videoId + "?autoplay=1&mute=1&controls=0&rel=0&showinfo=0")} frameborder="0" allow="autoplay; encrypted-media" allowfullscreen data-v-8b39cdcd></iframe><div class="video-caption" data-v-8b39cdcd><h1 data-v-8b39cdcd>I Love Kristen P</h1><p data-v-8b39cdcd>Bravo Networks</p></div></div></div>`);
}
...
const VideoBanner = /* @__PURE__ */ _export_sfc$1(_sfc_main$6, [["ssrRender", _sfc_ssrRender$6], ["__scopeId", "data-v-8b39cdcd"]]);
const sliderData = [
  {
...
//# sourceMappingURL=index-DQTL1RF5.mjs.map
