...
import { ssrRenderComponent, ssrRenderClass, ssrRenderSlot, ssrGetDirectiveProps, ssrRenderAttr, ssrRenderList, ssrRenderAttrs, ssrRenderSuspense, ssrRenderVNode, ssrInterpolate } from 'vue/server-renderer';
...
const _routes = [
  ...
  },
  {
    name: "login",
    path: "/login",
    component: () => import('./login-Ca8lv-aX.mjs').then((m) => m.default || m)
  },
  {
    name: "news",
    path: "/news",
  ...
  },
  {
    name: "register",
    path: "/register",
    component: () => import('./register-DM1SUToD.mjs').then((m) => m.default || m)
  },
  {
    name: "shows",
    path: "/shows",
